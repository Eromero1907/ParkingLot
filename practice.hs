...
obtenerV :: String -> Maybe Vehiculo
obtenerV linea = case reads linea :: [(Vehiculo, String)] of
    [(v, "")] -> Just v
    _         -> Nothing

-- Función para mostrar el historial del parqueadero en cuestión
historialP :: [Vehiculo] -> IO ()
historialP = mapM_ (putStrLn . mostrarVehiculo)
...
cargarParqueadero = do
    ...
    let vehiculos = mapMaybe obtenerV lineas
...
cicloPrincipal parqueadero = do
    ...
    putStrLn "4. Mostrar historial del parqueadero"
    putStrLn "5. Salir"
    ...
    case opcion of
        ...
        "4" -> do
            putStrLn "Mostrando historial parqueadero:"
            historialP parqueadero
            cicloPrincipal parqueadero
